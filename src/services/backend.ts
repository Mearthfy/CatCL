...
export const backend = {
  ...
  createP2pRoom: (instancePath: string, lanTimeoutSecs = 120, stunServer?: string) => native<P2pRoomSnapshot>('create_p2p_room', { instancePath, lanTimeoutSecs, stunServer }),
  joinP2pRoom: (inviteCode: string, stunServer?: string) => native<P2pRoomSnapshot>('join_p2p_room', { inviteCode, stunServer }),
